import '../../css/pageStyles/ArticleTemplate.css';

function potionsCollectibles() {
  return (
    <>
    ...
    <main className="article-main">
      <section className="article-header-holder">
        ...
        <div className="header-info-holder">
          <h1 className="article-title">Potions & Collectibles</h1>
          <h2>SoulSwap</h2>
...
export default potionsCollectibles;
